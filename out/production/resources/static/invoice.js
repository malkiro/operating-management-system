...
function viewitem(inv, rowno) {
    ...
    fillInnerTable("tblPrintInnerItem", invoice.invoiceItemList, mdifyInnerForm, deleteInnerForm);
...
function refreshInnerForm() {
    ...
    fillInnerTable("tblInnerItem", invoice.invoiceItemList, mdifyInnerForm, deleteInnerForm);
    ...
    if(invoice.corderId == null){
        swal({
            ...
            text: "\nInvoice No : " + invoice.invoiceno +
                ...
                "\nAmount Payable : " + invoice.payableamount +
...
function fillForm(inv, rowno) {
    ...
    txtPayable.value = invoice.payableamount;
    txtReturn.value = invoice.returnvalue;
