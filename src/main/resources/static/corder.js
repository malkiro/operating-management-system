            ...
            if (parseFloat(txtQty.value)<0){
                ...
                if (itemexs) {
                    ...
                    if(creditapprove){
                        ...
                        if (oldcorder != null && isEqual(corder.corderItemList, oldcorder.corderItemList, 'itemId')) {
...
function getErrors() {
    ...
    if (corder.requiredate == null){
        errors = errors + "\n" + "Required Date Not Selected";
        dteRequireddate.style.border = invalid;
    }
    else addvalue = 1;
...
function savedata() {
    ...
    swal({
        ...
        icon: "resourse/image/sorder.png",
        buttons: [
            'No, Cancel',
            'Yes, Save!'
        ],
    ...
    if (errors == "") {
        ...
        if (updates == "")
            ...
            swal({
                ...
                text: "\n" + getUpdates(),
                icon: "resourse/image/sorderup.png",
...
function btnDeleteMC(cor) {
    ...
    swal({
        ...
        text: "\nCustomer Order Number : " + corder.cono +
            ...
            "\nOrder Date : " + corder.date +
            "\nOrdered By : " + corder.employeeId.callingname,
        icon: "resourse/image/sorderdel.png",
