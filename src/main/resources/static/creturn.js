...
function initialize() {
    ...
    txtTax.addEventListener("keyup", txtTaxKU);
...
function selectDeleteRow() {
    for (index in customerreturns) {
        ...
        if (customerreturns[index].customerreturnstatusId.name == "Completed") {
            tblCreturn.children[1].children[index].lastChild.children[0].disabled = true;
            tblCreturn.children[1].children[index].lastChild.children[0].style.cursor = "not-allowed";
            tblCreturn.children[1].children[index].lastChild.children[1].disabled = true;
            tblCreturn.children[1].children[index].lastChild.children[1].style.cursor = "not-allowed";
        }
    }
...
function txtTaxKU() {
    txtNettotal.value = parseFloat(txtTotalaount.value)  + parseFloat(txtTax.value);
    customerreturn.nettotal = txtNettotal.value;
...
function savedata() {
    ...
    swal({
        ...
        text: "\nCustomer Order Number : " + customerreturn.returnno +
            ...
            "\nTax Value Value : " + customerreturn.taxvalue +
            "\nNet Value : " + customerreturn.nettotal +
        ...
        icon: "resourse/image/creturnadd.png",
        buttons: [
            'No, Cancel',
            'Yes, Save!'
        ],
...
function fillForm(cusr, rowno) {
    ...
    txtTax.value = customerreturn.taxvalue;
    txtNettotal.value = customerreturn.nettotal;
    ...
    if (errors == "") {
        ...
        if (updates == "")
            ...
            swal({
                ...
                text: "\n" + getUpdates(),
                icon: "resourse/image/creturnup.png",
...
function btnDeleteMC(cusr) {
    ...
    swal({
        ...
        text: "\nCustomer Order Number : " + customerreturn.returnno +
            ...
            "\nOrder Date : " + customerreturn.date +
            "\nOrdered By : " + customerreturn.employeeId.callingname,
        icon: "resourse/image/creturndel.png",
