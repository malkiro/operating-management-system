...
function loadForm() {
    ...
    setStyle(initial);
    txtCNumber.style.border=initial;
...
function savedata() {
    ...
    if(customer.ctypeId.id ==1 || customer.ctypeId.id ==2){
        swal({
            ...
            icon: "resourse/image/customer.png",
            buttons: [
                'No, Cancel',
                'Yes, Save!'
            ],
    ...
    if (errors == "") {
        ...
        if (updates == "")
            ...
            swal({
                ...
                text: "\n"+ getUpdates(),
                icon: "resourse/image/customerup.png",
...
function btnDeleteMC(cus) {
    ...
    swal({
        ...
        text :"\nNumber : " + customer.regno +
            ...
            "\nCustomer Status : " + customer.cstatusId.name +
            "\nAdded By : " + customer.employeeId.callingname,
        icon: "resourse/image/customerdel.png",
